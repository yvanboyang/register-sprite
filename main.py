...
class MyGui(Frame):
    ...
    # event start ***************************************************
    def update_btn_val_by_entry_dec(self, event):

        dec_data = self.decimal_output.get()
    ...
    def update_btn_val_by_entry_ascii(self, event):
        dec_data = ord(self.entry_asci.get())
    ...
    def __init__(self, asci_data, master=None):
        super().__init__(master)
        self.main_window_title = 'register splite'
        self.Window = master  # 主窗体
        self.pack()
        self.asci_data = asci_data
        ...
        self.bg_color = self.make_struct('backgroundcolor', "#b0c4de")
    ...
    def init_view(self):
        ...
        self.decimal_output = Entry(self.frame_entry,
                                    ...
                                    width=40,
                                    font=("宋体", 12, "bold"))
        self.decimal_output.bind('<Return>', func=self.update_btn_val_by_entry_dec)
        ...
        self.frame_asci = Frame(self.frame_choice)
        # asci
        self.label_asci = Label(self.frame_asci,
                                    background=self.bg_color.value,
                                    text="  ASCII",
                                    font=("宋体", 9, "bold"))
        self.label_asci.pack(side=LEFT)
        self.entry_asci = Entry(self.frame_asci,
                                    background='#f0f0f0',
                                    width=11,
                                    font=("宋体", 12, "bold"))

        self.entry_asci.bind('<Return>', func=self.update_btn_val_by_entry_ascii)
        self.entry_asci.pack(side=LEFT)
        self.frame_asci.configure(bg=self.bg_color.value)
        self.frame_asci.pack(side=TOP, pady=5, anchor='w')
    ...
    def show_data(self):
        ...
        if(dec >= 0 and dec <= 127):
            self.entry_asci.insert(0,self.asci_data[str(dec)])
        else:
            self.entry_asci.insert(0, "ERROR")
    '''
    ...
    def ChangeBackgroundColor(self, color):
        ...
        try:
            ...
            self.label_asci.config(bg=self.bg_color.value)
            return err
        except:
            return -err
...
def main():
    if __name__ == '__main__':
        ...
        with open(get_resource_path('config/Ascii_table.json'), 'r', encoding='utf-8') as f:
            data = json.load(f)
        app = MyGui(master=root,asci_data=data)
        app.mainloop()
